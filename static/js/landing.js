...
(function () {
  ...
  if (hero) {
    ...
    function heroApply(pct) {
      // Also set the concrete values, not just the CSS variable: Chromium does
      // not always repaint clip-path when a referenced CSS var changes.
      if (heroOverlay) heroOverlay.style.clipPath = 'inset(0 ' + (100 - pct) + '% 0 0)';
